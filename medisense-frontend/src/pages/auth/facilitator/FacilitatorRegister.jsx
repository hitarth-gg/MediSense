          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input id="email" type="email" placeholder="facilitator@example.com" value={formData.email}
              ...
              <div className="grid md:grid-cols-3 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input id="district" placeholder="Enter district" value={formData.district}
                    onChange={(e) => setFormData({ ...formData, district: e.target.value })} required />
                </div>

                <div className="space-y-2">
                  <Label htmlFor="village">Village/Area *</Label>
                  <Input id="village" placeholder="Enter village/area" value={formData.village}
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input id="education" placeholder="e.g., 12th Pass, Graduate" value={formData.education}
                    onChange={(e) => setFormData({ ...formData, education: e.target.value })} />
                </div>
                <div className="space-y-2">
                  <Label htmlFor="experience">Healthcare Experience</Label>
                  <Input id="experience" placeholder="e.g., 2 years as ASHA worker" value={formData.experience}
              ...
              <div className="space-y-2">
                ...
                <Input id="languages" placeholder="e.g., Hindi, English, Local dialect" value={formData.languages}
